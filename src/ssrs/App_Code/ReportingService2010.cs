...
namespace ssrs.App_Code
{
    ...
    public partial class ReportingService2010 : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        {
            return ("/ReportService2010.asmx");
        }

    
        public List<string> ListFolders(string parent) 
        {
            List<string> folders = new List<string>();
            CatalogItem[] items = this.ListChildren(parent, false);
        ...
        public List<string> ListDataSources(string parent) 
        {
            List<string> dataSources = new List<string>();
            CatalogItem[] items = this.ListChildren(parent, false);
            foreach (CatalogItem item in items)
                if (item.TypeName == "DataSource")
                    dataSources.Add(item.Name);
            return (dataSources);
        }

        public List<string> ListDataSets(string parent) 
        {
        ...
        {
            //this.Url = global::WindowsFormsApplication1.Properties.Settings.Default.WindowsFormsApplication1_tubarao_ReportingService2010;
